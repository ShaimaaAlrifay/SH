...
export function Footer() {
  ...
  const socialLinks = [
    { name: "GitHub", icon: Github, href: "https://github.com/ShaimaaAlrifay" },
    { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/shaimalrifay/" },
    { name: "Twitter", icon: Twitter, href: "https://x.com/I1sh1" },
  ];
